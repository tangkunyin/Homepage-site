...
/* https://zeptojs.com/#modules/fx.js */
(function($, undefined){
...
$(document).ready(function() {
  ...
  $('a.blog-button').click(function() {
    ...
    if (currentWidth < 960) {
      ...
      $('.panel-cover').animate({'max-width': '500px', 'width': '30%'}, 400, 'swing');
    }
  });
...
function setInitialData(){
  ...
  if ([918, 1024, 1222].indexOf(today) > -1) {
    coverIndex = today;
  } else {
    coverIndex = parseInt(Math.random() * 18);
  }
  var coverImage = "/images/covers/"+coverIndex+".jpg";
  $(".panel-cover").css({"background":"url('"+coverImage+"') top left no-repeat #666666","background-image":coverImage,"background-size": "cover"});
}
